...
def test(args, seg_model, test_loader, text_features):
    ...
    #print(f"gt_list shape: {gt_list.shape}")
    #print(f"gt_mask_list shape: {gt_mask_list.shape}")
    #print(f"segment_scores shape: {segment_scores.shape}")
    #print(f"image_scores shape: {image_scores.shape}")
    ...
    with open(f"{args.log_dir}/{args.obj}-scores.csv", "a") as file:
